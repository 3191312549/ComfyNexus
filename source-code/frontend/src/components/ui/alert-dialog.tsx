...
>(({ className, closeOnOverlayClick = false, onOverlayClick, ...props }, ref) => {
  const handleOverlayClick = React.useCallback((e: React.MouseEvent) => {
    if (closeOnOverlayClick && onOverlayClick) {
      if (e.target === e.currentTarget) {
        onOverlayClick()
      }
    }
  }, [closeOnOverlayClick, onOverlayClick])
