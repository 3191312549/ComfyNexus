...
interface WorkflowBatchToolbarProps {
...
export function WorkflowBatchToolbar({
  selectedCount,
  totalCount,
  onClearSelection,
  onBatchFavorite,
  ...
  return (
    ...
    >
      <span className="text-sm font-medium text-foreground">
        {t('workflow.batch.selected', { count: selectedCount, total: totalCount })}
      </span>
